...
public class CRUDmhs extends JFrame {
    ...
    private void initComponents() {
        ...
        c.gridx = 1; c.gridy = 0; c.gridwidth = 2; add(jTextField1, c); c.gridwidth = 1;
        c.gridx = 0; c.gridy = 1; add(jLabel2, c);
        c.gridx = 1; c.gridy = 1; c.gridwidth = 2; add(jTextField2, c); c.gridwidth = 1;
        c.gridx = 0; c.gridy = 2; add(jLabel3, c);
        c.gridx = 1; c.gridy = 2; c.gridwidth = 2; add(jTextField3, c); c.gridwidth = 1;
        c.gridx = 0; c.gridy = 3; add(jLabel4, c);
        c.gridx = 1; c.gridy = 3; c.gridwidth = 2; add(jTextField4, c); c.gridwidth = 1;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new CRUDmhs().setVisible(true));
    }
